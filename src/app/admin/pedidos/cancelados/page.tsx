        ...
        <div className="min-h-screen bg-gray-100 p-4 sm:p-6 lg:p-10">
            <main className="max-w-7xl mx-auto bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
                ...
                <div className="mb-4 text-sm text-gray-600 font-medium">
                    Total: <span className="font-bold text-gray-800">{pedidos.length}</span> pedido{pedidos.length !== 1 ? 's' : ''} cancelado{pedidos.length !== 1 ? 's' : ''}
                </div>
                    ...
                    <>
                        ...
                        <div className="lg:hidden space-y-4">
                            {pedidos.map((pedido: any) => (
                                <div
                                    key={pedido.id}
                                    className="bg-white border-2 border-red-300 rounded-xl p-5 shadow-md hover:shadow-lg transition-shadow"
                                >
                                    {/* Info del pedido */}
                                    <div className="mb-4">
